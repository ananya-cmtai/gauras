...
const RazorpayWebViewSubscribe: React.FC<Props> = () => {
   const { amount: amountParam, payload } = useLocalSearchParams();
...
export default RazorpayWebViewSubscribe;
